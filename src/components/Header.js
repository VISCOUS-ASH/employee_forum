  ...
  return (
    <header className="flex justify-between items-center bg-blue-500 p-4 shadow-md">
      ...
      <div className="flex items-center">
        <img src="https://github.com/VISCOUS-ASH/employee_forum/blob/main/src/images/timetable.png" alt="Logo" className="h-8 w-8 mr-3" />
      ...
      <div className="flex items-center space-x-3">
        ...
        <img
          src="https://github.com/VISCOUS-ASH/employee_forum/blob/main/src/images/photo_bg.png"
          alt="Profile"
